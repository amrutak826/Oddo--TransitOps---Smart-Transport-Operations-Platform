...
* Role Based Security - Fleet Manager, Dispatcher, Driver, Viewer access levels
    ...
    'data': [
        ...
        # Reports - pivot/graph/list report actions
        'views/transit_reports_views.xml',

        # PDF Reports
        'reports/transit_report_templates.xml',
        'reports/transit_fleet_report.xml',
        'reports/transit_driver_report.xml',
        'reports/transit_trip_report.xml',
        'reports/transit_maintenance_report.xml',
        'reports/transit_expense_report.xml',
